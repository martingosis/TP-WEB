							...
							<div class="row"> 
									...
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.php">Televisor Samsung 50 Full HD</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">$500.00</span>
                                            </div>
                                            <div class="info-product-price my-2">
												<span>5.2", 1080 x 1920 pixels
                                                      Tamaño de Pantalla 50" Tipo de resolución FULL HD Resolución 3840 x 2160 píxeles Formato de pantalla Plano
                                                </span>
                                            </div>
