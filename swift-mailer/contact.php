<?php
  ...
  ->setPassword('PASS')
   ...
   $mailer = new Swift_Mailer($transport);
    ...
    // Create a message   $message = (new Swift_Message('Form Submission'))
  ->setFrom([EMAIL => 'martin.esteban.gosis'])
  ->setTo(['martin.esteban.gosis@gmail.com'])
  ->setBody('Name : '.$_POST['name'].'<br>Email :'.$_POST['email'].'
   <br>Phone : '.$_POST['phone'].'<br>Message : '.$_POST['message'],
    'text/html')
    ;
