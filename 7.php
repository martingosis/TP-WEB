								...
								<div class="col-md-12 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.php">Samsung S20</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">$850.00</span>
                                            </div>
                                            <div class="info-product-price my-2">
												<span>Pantalla de 6,7 pulgadas de 120 Hz QHD plus OLED, Snapdragon 865, 12 GB de RAM, 128/512 GB y microSD, 4500 mAh, cámaras de 12 + 64 + 12 MP + profundidad, cámara de selfie de 10 MP, IP68</span>
                                            </div>
